...
wslbridge2_base = --WSLmode -e /bin/wslbridge2 %distro_option% -e SHELL=%shell% -e LANG -e WSL_HOST_IP -e WSL_GUEST_IP -e DISPLAY=%A_IPAddress4%:0
...
if (exe_name == "run-wsl-file") {
    ...
    Run, %mintty_base% %mintty_options% -T "%exe_name%" %wslbridge2_base% "%exe_name%" %options% %filename%
